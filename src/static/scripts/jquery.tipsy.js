...
(function($) {
    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (title && this.enabled) {
                ...
                switch (gravity.charAt(0)) {
                    ...
                    case 's':
                        tp = {
                            ...
                            left: pos.left - this.options.offset + pos.width / 2 - actualWidth / 2
                        };
                        break;
                    case 'e':
                        tp = {
                ...
                if (this.options.fade) {
                    ...
                    }, this.options.fadeAnimationDuration);
                } else {
                    $tip.css({
                        visibility: 'visible',
                        opacity: this.options.opacity
        ...
        hide: function() {
            if (this.options.fade) {
                this.tip().stop().fadeOut(this.options.fadeAnimationDuration, function() {
                    $(this).remove();
                });
            } else {
                this.tip().remove();
